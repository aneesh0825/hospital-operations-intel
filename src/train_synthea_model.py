...
# --------------------------------------------------
# LOAD SYNTHEA READMISSION DATASET
# --------------------------------------------------
...
print("=" * 50)
print("SYNTHEA READMISSION DATASET")
print("=" * 50)
...
# Make sure testing columns match training columns
...
# --------------------------------------------------
# ENCODE INNER TRAIN / VALIDATION DATA
# --------------------------------------------------
...
# Make validation columns identical to inner training
X_validation_encoded = X_validation_encoded.reindex(
...
# Train final XGBoost using ALL training patients
xgb_model.fit(
    X_train_encoded,
    y_train
)
...
# Generate probabilities on untouched test patients
...
# --------------------------------------------------
# FINAL TEST EVALUATION USING LOCKED THRESHOLD
# --------------------------------------------------
...
for fold, (cv_train_index, cv_validation_index) in enumerate(
    group_kfold.split(
        X,
        y,
        groups=groups
