...
print("=" * 70)
print("BUILDING ADMITRA TEMPORAL HISTORY DATASET")
print("=" * 70)
...
for counter, row in index_encounters.iterrows():
    ...
    # LEAKAGE PROTECTION:
    #
    # A prior hospitalization is only allowed to contribute
    # its readmitted_30_days outcome if the entire 30-day
    # outcome window had already finished BEFORE the current
    # hospitalization began.
    #
    # Example:
    #
    # Prior admission: January 1
    # Current admission: January 20
    #
    # We cannot use the January 1 hospitalization's 30-day
    # readmission label because its outcome window does not
    # close until January 31.
    #
    # Prior admission: January 1
    # Current admission: February 10
    #
    # That prior outcome is safe because its 30-day window
    # had already closed before February 10.
    # --------------------------------------------------------
...
# ============================================================
#
# Patients with no prior inpatient admission should not be
# treated as though they had a recent admission.
#
# We therefore:
#
# 1. Create an explicit indicator for prior inpatient history.
#
# 2. Cap days since admission at 365 days.
#
# 3. Assign 365 days to patients with no prior inpatient
#    admission.
# ============================================================
